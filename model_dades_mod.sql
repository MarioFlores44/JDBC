...
CREATE TABLE IF NOT EXISTS `mydb`.`comunitats_autonomes` (
  ...
  UNIQUE INDEX `uk_com_aut_codi_ine` (`codi_ine` ASC)  )
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mydb`.`provincies` (
  ...
  UNIQUE INDEX `uk_provincies_codi_ine` (`codi_ine` ASC)  ,
...
CREATE TABLE IF NOT EXISTS `mydb`.`municipis` (
  ...
  UNIQUE INDEX `uk_municipis_codi` (`codi_ine` ASC, `provincia_id` ASC, `districte` ASC)  ,
  INDEX `idx_fk_municipis_provincies1` (`provincia_id` ASC)  ,
...
CREATE TABLE IF NOT EXISTS `mydb`.`persones` (
  ...
  UNIQUE INDEX `uk_candidats_dni` (`dni` ASC)  )
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mydb`.`candidats` (
  ...
  INDEX `fk_candidats_provincies1_idx` (`provincia_id` ASC)  ,
  INDEX `fk_candidats_persones1_idx` (`persona_id` ASC)  ,
  INDEX `fk_candidats_candidatures1_idx` (`candidatura_id` ASC)  ,
  UNIQUE INDEX `uk_candidats_persona_cand` (`candidatura_id` ASC, `persona_id` ASC)  ,
